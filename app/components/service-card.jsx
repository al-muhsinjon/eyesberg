...
const ServiceCard = ({ data }) => {
  ...
  return (
    <Link
      href={id}
      className="bg-white rounded-xl hover:shadow-xl 2xl:px-12 md:px-4 px-4 py-4 flex  justify-around  items-start flex-col"
    >
      <div className="flex md:flex-row relative  flex-col justify-between md:gap-12 items-center">
        ...
        <h2 className="2xl:text-3xl text-xl  xl:text-2xl font-bold ">
          {text}
        </h2>
      </div>
